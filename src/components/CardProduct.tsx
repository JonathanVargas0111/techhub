        ...
        <div className='relative flex w-full flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md'>
            ...
            <div className='mt-4 px-5 pb-5'>
                ...
                <div className='flex flex-col space-y-2'>
                    ...
                    <div className="mt-2 mb-5 flex items-center justify-between">
                        <p className='space-x-1'>
                            <span className="text-3xl font-bold text-slate-900">
                                {stock > 0 ? `$${(price - price * (discount / 100)).toFixed(2)}` : ""}
                            </span>
                    ...
                    <button className={cn("flex items-center justify-center rounded-md bg-slate-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300", stock <= 0 && "hover:bg-background bg-background text-gray-500 cursor-default")}>
